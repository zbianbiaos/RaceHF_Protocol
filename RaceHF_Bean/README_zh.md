...
> 获取设备ID:  
> 写: 0x05 0x00  
> 立即收到通知: 0x15 0x06 0x12 0x23 0x34 0x45 0x56 0x67  
> 或读到: 0x15 0x06 0x12 0x23 0x34 0x45 0x56 0x67  
...
> 获取三星定位卫星数目：  
> 写：0x11 0x00  
> 立即收到通知：0x11 0x04 0x0E 0x09 0x02 0x03  
> 或读到：0x11 0x04 0x0E 0x09 0x02 0x03 0x6E  
> 表示回应的是id=0x11的内容，内容长度是4字节，定位卫星数14颗，GPS卫星数为9颗，格洛纳斯卫星数为2颗，伽利略卫星数为3颗
