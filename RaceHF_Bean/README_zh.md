...
> 纬度原始数据为：0x91 0x91 0xBB 0x21 0xF0 0x74 0x37 0xC0   => 维度 = -23.45678912  
...
设置*用户ID*，*SD卡开始记录触发方式*，*SD卡开始记录触发速度*，*SD卡停止记录超时时间*，*SD卡记录文件类型*和*SD卡记录文件时区*。
